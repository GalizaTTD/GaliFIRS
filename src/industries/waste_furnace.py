...
industry.enable_in_economy(
    "GALIZA",
    accept_cargo_types=["WSTE"],
)

industry.add_tile(
    id="waste_furnace_tile_1",
    animation_length=7,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_empty",
    tile="waste_furnace_tile_1",
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_tanks",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_air_plant",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_furnace",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_casting_shed",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_metal_1",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_small_shed",
    tile="waste_furnace_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_animated_casting_front_part",
    tile="waste_furnace_tile_2",
...
industry.add_spritelayout(
    id="waste_furnace_spritelayout_animated_casting_rear_part",
    tile="waste_furnace_tile_2",
...
industry.add_industry_outpost_layout(
    id="waste_furnace_industry_outpost_layout_1",
    layout=[
        # test outpost layout
        (
            0,
            0,
            "waste_furnace_spritelayout_casting_shed",
        ),
        (
            0,
            1,
            "waste_furnace_spritelayout_air_plant",
        ),
        (
            1,
            0,
        ...
        (
            1,
            1,
            "waste_furnace_spritelayout_tanks",
        ),
        (
            2,
            0,
            "waste_furnace_spritelayout_metal_1",
        ),
        (
            2,
            1,
            "waste_furnace_spritelayout_small_shed",
        ),
    ],
)
# core layouts are roughly 4x4 or 3x5
industry.add_industry_layout(
    id="waste_furnace_industry_layout_1",
    layout=[
        (
            0,
            0,
        ...
        (
            1,
            3,
            "waste_furnace_spritelayout_furnace",
        ),
        (
            1,
            4,
        ...
        (
            2,
            2,
            "waste_furnace_spritelayout_animated_casting_rear_part",
        ),
        (
            2,
            3,
            "waste_furnace_spritelayout_animated_casting_front_part",
        ),
        (
            2,
            4,
...
industry.add_industry_layout(
    id="waste_furnace_industry_layout_2",
    layout=[
        (
            0,
            0,
...
industry.add_industry_layout(
    id="waste_furnace_industry_layout_3",
    layout=[
        (
            0,
            0,
...
industry.add_industry_layout(
    id="waste_furnace_industry_layout_4",
    layout=[
        (
            0,
            0,
...
industry.add_industry_layout(
    id="waste_furnace_industry_layout_5",
    layout=[
        (
            0,
            0,
